...
export default function OurOffers (){
  ...
  const offers = [
    {
      id: 1,
      title: "Braces for Just $3,999",
      subtitle: "Limited Time Offer!",
      description: "Affordable Braces, Unbeatable Smiles – Because You Deserve It!",
      image: "/Images/banners/div.elementor-widget-wrap (4).png",
      badge: "Special Offer",
      buttonText: "Learn More"
    },
    {
      id: 2,
      title: "New Patient? Your First Exam & X-Ray Are On Us!",
      subtitle: "",
      description: "No hidden fees, no obligations - a healthy start for your teeth! Call now to book your free exam.",
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
              At Urban Dental, we go beyond just treating teeth—we care for your complete oral health. With expertise and warmth, we ensure you leave every visit smiling with confidence. From cleanings and preventive care to cosmetic, restorative, and advanced treatments like implants and Invisalign, we offer comprehensive, comfortable, and stress-free dental solutions tailored to you.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm border border-blue-100 rounded-3xl p-8 shadow-lg max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-gradient-to-r from-primary via-primary-500 to-primary hover:from-blue-700 hover:to-cyan-600 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 whitespace-nowrap">
                  Book Appointment
                </button>
