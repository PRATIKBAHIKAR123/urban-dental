    ...
    return (
        <div className="w-full">
            ...
            <div className="details-page-header-section flex flex-col items-center justify-center">
                <h1>Teeth Whitening Special in Bayonne, NJ</h1>
                <h2>
                    Professional Whitening for Just $299 | Urban Dental & Braces | Family & Cosmetic Dentist
                </h2>
            </div>
            ...
            <div className="max-w-7xl mx-auto text-center py-10 px-4">
                ...
                <p className="mb-2">Looking for a way to refresh your smile without breaking the bank? At Urban Dental & Braces Bayonne, we're making it easy with our $299 Teeth Whitening Special—a limited-time offer for new and existing patients. Enjoy professional-grade whitening in a single visit with no hidden fees, no pressure, and all the confidence that comes with a whiter smile.</p>
                <p className="mb-2 p-4">Our dental office proudly serves Bayonne, Greenville. If you've been searching for "teeth whitening near me," your brighter smile starts here.</p>
            ...
            <div className="w-full details-page-header-section text-left text-white py-10 px-4">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-xl md:text-3xl font-bold mb-4">Why Choose Urban Dental Bayonne?</h2>
                    <p className="mb-4">Choosing the right dentist for cosmetic treatments matters. Here’s why patients across Bayonne and nearby neighborhoods trust us:</p>
                    <ul className="space-y-2 text-base">
                        ...
                        <li className="flex items-center gap-2"><CheckCircle size={18}/> Trusted by Families in Bayonne, Greenville</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto py-12 px-4">
                ...
                <p className="text-center mb-8">From check-in to checkout, your visit at Urban Dental Beyonne is all about comfort, efficiency, and results. Here's what your teeth whitening experience looks like:</p>
